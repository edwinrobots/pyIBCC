...
public class PopDensitySimple {
    public static void main(String[] args)
    {
    	try{
	        MACE em;
	        String file = "../../data/crowd_matrix_nepal_2015_nonans.csv";
	        em = new MACE(file);
	        ...
	        String predictionName = "../../output/popdensity_mace_predicted_labels.csv";
	        ...
	        String competenceName = "../../output/popdensity_mace_competence.csv";
	        em.writeArrayToFile(competence, competenceName, "\n");
	
	        // generate entropies
	        double[][] pArray = em.getLabelProbabilities();
	        String pName = "../../output/popdensity_mace_probabilities.csv";
